	...
	<div id="content" class="<?php echo $post_layout; ?>">
		...
		<?php if(is_author()) : ?>
			...
			<div class="author-bio clearfix">
				...
				<h2 class="author-name"><?php _e('Об авторе','themify'); ?> <?php echo $curauth->first_name; ?> <?php echo $curauth->last_name; ?></h2>
			...
			<h2 class="author-posts-by"><?php _e('Записи от','themify'); ?> <?php echo $curauth->first_name; ?> <?php echo $curauth->last_name; ?>:</h2>
		<?php endif; ?>
		...
		?>
		<?php if(is_search()): ?>
			<h1 class="page-title"><?php _e('Результаты поиска для:','themify'); ?> <em><?php echo $s; ?></em></h1>
		<?php endif; ?>
		...
		<?php else : ?>
			...
			<p><?php _e( 'К сожалению, ничего не найдено.', 'themify' ); ?></p>
