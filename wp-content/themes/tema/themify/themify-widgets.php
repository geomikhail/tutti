...
*/
	...
	class Themify_Feature_Posts extends WP_Widget {
		...
		function Themify_Feature_Posts() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'feature-posts', 'description' => 'Список записей, дополнительно фильтруйте по категориям.' );
	
			/* Widget control settings. */
			$control_ops = array( 'id_base' => 'themify-feature-posts' );
	
			/* Create the widget. */
			$this->WP_Widget( 'themify-feature-posts', 'Themify - Свежие записи', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' => 'Свежие записи', 'category' => 0, 'show_count' => 5, 'show_date' => false, 'show_thumb' => false, 'show_excerpt' => false, 'hide_title' => false, 'thumb_width' => 50, 'thumb_height' => 50, 'excerpt_length' => 55 );
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'category' ); ?>">Рубрики:</label>
				<select id="<?php echo $this->get_field_id( 'category' ); ?>" name="<?php echo $this->get_field_name( 'category' ); ?>">
					<option value="0" <?php if ( !$instance['category'] ) echo 'selected="selected"'; ?>>Все</option>
					<?php
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">Показывать:</label>
				<input id="<?php echo $this->get_field_id( 'show_count' ); ?>" name="<?php echo $this->get_field_name( 'show_count' ); ?>" value="<?php echo $instance['show_count']; ?>" size="2" /> записей
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'hide_title' ); ?>">Скрыть заголовок записи</label>
			</p>
			
			<p>
				<input class="checkbox" type="checkbox" <?php checked( $instance['show_date'], 'on' ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
				<label for="<?php echo $this->get_field_id( 'show_date' ); ?>">Отображать дату записи</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_thumb' ); ?>">Отображать миниатюру записи</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>">Отображать отрывок записи</label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'excerpt_length' ); ?>">Символьный предел отрывка:</label>
	...
	class Themify_List_Pages extends WP_Widget {
		...
		function Themify_List_Pages() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'list-pages', 'description' => 'Список страниц' );
	
			/* Widget control settings. */
			$control_ops = array( 'id_base' => 'themify-list-pages' );
	
			/* Create the widget. */
			$this->WP_Widget( 'themify-list-pages', 'Themify - Список страниц', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Страницы', 'parent' => '', 'depth' => 0, 'orderby' => 'post_title', 'exclude' => '' );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'parent' ); ?>">Отображать:</label>
				<select id="<?php echo $this->get_field_id( 'parent' ); ?>" name="<?php echo $this->get_field_name( 'parent' ); ?>">
					<option value="0" <?php if ( 0 == $instance['parent'] ) echo 'selected="selected"'; ?>>Все</option>
					<?php
					$pages = get_pages();
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'depth' ); ?>">Глубина:</label>
				<select id="<?php echo $this->get_field_id( 'depth' ); ?>" name="<?php echo $this->get_field_name( 'depth' ); ?>">
					<option value="0" <?php if ( 0 == $instance['depth'] ) echo 'selected="selected"'; ?>>0 (по умолчанию)</option>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'orderby' ); ?>">Сортировать по:</label>
				<select id="<?php echo $this->get_field_id( 'orderby' ); ?>" name="<?php echo $this->get_field_name( 'orderby' ); ?>">
					<option value="id" <?php if ( 'id' == $instance['orderby'] ) echo 'selected="selected"'; ?>>ID</option>
					<option value="menu_order" <?php if ( 'menu_order' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Порядок меню</option>
					<option value="post_title" <?php if ( 'post_title' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Заголовок записи</option>
					<option value="post_date" <?php if ( 'post_date' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Дата записи</option>
					<option value="post_name" <?php if ( 'post_name' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Имя записи</option>
				</select>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'exclude' ); ?>">Исключить:</label><br />
				<input id="<?php echo $this->get_field_id( 'exclude' ); ?>" name="<?php echo $this->get_field_name( 'exclude' ); ?>" value="<?php echo $instance['exclude']; ?>" /><br />
				<small>ИД Страниц, через запятую (напр. 5,8)</small>
			</p>
	...
	class Themify_List_Categories extends WP_Widget {
		...
		function Themify_List_Categories() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'list-categories', 'description' => 'Список рубрик' );
	
			/* Widget control settings. */
			$control_ops = array( 'id_base' => 'themify-list-categories' );
	
			/* Create the widget. */
			$this->WP_Widget( 'themify-list-categories', 'Themify - Список рубрик', $widget_ops, $control_ops );
		}
		...
		function widget( $args, $instance ) {
			...
			if ( $show_dropdown ) {
				$args['show_option_none'] = __('Выберите рубрику');
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Рубрики', 'parent' => 0, 'depth' => 0, 'orderby' => 'name', 'exclude' => '', 'show_dropdown' => false, 'show_counts' => false, 'show_hierarchy' => true );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				...
				<select id="<?php echo $this->get_field_id( 'orderby' ); ?>" name="<?php echo $this->get_field_name( 'orderby' ); ?>">
					<option value="id" <?php if ( 'id' == $instance['orderby'] ) echo 'selected="selected"'; ?>>ID</option>
					<option value="name" <?php if ( 'name' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Имя</option>
					<option value="slug" <?php if ( 'slug' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Краткий заголовок</option>
					<option value="count" <?php if ( 'count' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Счет</option>
				</select>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'exclude' ); ?>">Исключить:</label><br />
				<input id="<?php echo $this->get_field_id( 'exclude' ); ?>" name="<?php echo $this->get_field_name( 'exclude' ); ?>" value="<?php echo $instance['exclude']; ?>" /><br />
				<small>ID Рубрик, через запятую (напр. 5,8)</small>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_dropdown' ); ?>">Показать как выпадающий</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_counts' ); ?>">Показывать количество записей</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_hierarchy' ); ?>">Показывать иерархию</label>
			</p>
	...
	class Themify_Recent_Comments extends WP_Widget {
		...
		function Themify_Recent_Comments() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'recent-comments', 'description' => 'Список последних комментариев со всех записей' );
	
			/* Widget control settings. */
			$control_ops = array( 'id_base' => 'themify-recent-comments' );
	
			/* Create the widget. */
			$this->WP_Widget( 'themify-recent-comments', 'Themify - Свежие комментарии', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Свежие Комментарии', 'show_count' => 3, 'show_avatar' => false, 'avatar_size' => 32, 'excerpt_length' => 60 );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'avatar_size' ); ?>">Размер аватара:</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'excerpt_length' ); ?>">Отрывок комментария:</label>
				<input id="<?php echo $this->get_field_id( 'excerpt_length' ); ?>" name="<?php echo $this->get_field_name( 'excerpt_length' ); ?>" value="<?php echo $instance['excerpt_length']; ?>" size="4" /> символов
			</p>
	...
	class Themify_Links extends WP_Widget {
		...
		function Themify_Links() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'links', 'description' => 'Список закладок' );
	
			/* Widget control settings. */
			$control_ops = array( 'id_base' => 'themify-links' );
	
			/* Create the widget. */
			$this->WP_Widget( 'themify-links', 'Themify - Баннеры и Ссылки', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Блогролл', 'category' => '', 'orderby' => 'rand', 'show_count' => 10, 'show_thumb' => false, 'show_name' => false, 'show_desc' => false );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'category' ); ?>">Рубрика:</label>
				<select id="<?php echo $this->get_field_id( 'category' ); ?>" name="<?php echo $this->get_field_name( 'category' ); ?>">
					<option value="" <?php if ( '' == $instance['category'] ) echo 'selected="selected"'; ?>>Все</option>
					<?php
			...
			<p>
				...
				<select id="<?php echo $this->get_field_id( 'orderby' ); ?>" name="<?php echo $this->get_field_name( 'orderby' ); ?>">
					<option value="id" <?php if ( 'id' == $instance['orderby'] ) echo 'selected="selected"'; ?>>ID</option>
					<option value="name" <?php if ( 'name' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Имя</option>
					<option value="rating" <?php if ( 'rating' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Рейтинг</option>
					<option value="rand" <?php if ( 'rand' == $instance['orderby'] ) echo 'selected="selected"'; ?>>Случайно</option>
				</select>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">Лимит:</label>
			...
			<p>
				<input class="checkbox" type="checkbox" <?php checked( $instance['show_thumb'], 'on' ); ?> id="<?php echo $this->get_field_id( 'show_thumb' ); ?>" name="<?php echo $this->get_field_name( 'show_thumb' ); ?>" />
				<label for="<?php echo $this->get_field_id( 'show_thumb' ); ?>">Показывать изображение ссылки</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_name' ); ?>">Показывать имя ссылки</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_desc' ); ?>">Показывать описание ссылки</label>
			</p>
	...
	*/
	...
	class Themify_Twitter extends WP_Widget {
		...
		function Themify_Twitter() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'twitter', 'description' => 'Список последних твитов' );
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Последние твиты', 'username' => '', 'show_count' => 10, 'hide_timestamp' => false, 'hide_url' => false, 'show_follow' => true , 'follow_text' => 'Follow me' );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'username' ); ?>">Twitter Имя:</label>
				<input id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" value="<?php echo $instance['username']; ?>" />
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">Показывать:</label>
				<input id="<?php echo $this->get_field_id( 'show_count' ); ?>" name="<?php echo $this->get_field_name( 'show_count' ); ?>" value="<?php echo $instance['show_count']; ?>" size="3" /> твитов
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'hide_timestamp' ); ?>">Скрыть метки</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'hide_url' ); ?>">Скрыть твит ссылку</label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'show_follow' ); ?>">Отображать следуй за мной кнопку</label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'follow_text' ); ?>">Следуй за Мной текст:</label>
	...
	class Themify_Flickr extends WP_Widget {
		...
		function Themify_Flickr() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'flickr', 'description' => 'Катушка последних фотографий из Flickr' );
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => 'Свежие фотографии', 'username' => '', 'show_count' => 10 );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'username' ); ?>">Flickr ИД:</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">Показывать:</label>
				<input id="<?php echo $this->get_field_id( 'show_count' ); ?>" name="<?php echo $this->get_field_name( 'show_count' ); ?>" value="<?php echo $instance['show_count']; ?>" size="2" /> фотографий
			</p>
