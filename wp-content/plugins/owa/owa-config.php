...
define('OWA_DB_NAME', 'u196217935_wordpres'); // name of the database
define('OWA_DB_HOST', 'mysql.hostinger.ru'); // host name of the server housing the database
define('OWA_DB_USER', 'u196217935_admin'); // database user
define('OWA_DB_PASSWORD', '26841397'); // database user's password
...
define('OWA_PUBLIC_URL', 'http://tutti.tk/wp-content/plugins/owa/');  
